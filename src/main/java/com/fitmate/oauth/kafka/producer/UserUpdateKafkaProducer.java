...
public class UserUpdateKafkaProducer {
    ...
    public UserUpdateKafkaProducer(KafkaTemplate<String, byte[]> kafkaTemplate, ObjectMapper objectMapper) {
    ...
    @Value("${spring.kafka.topic-config.user-update-event.topic-name}")
    private String topicName;
    public void handleEvent(UserUpdateEvent event) {
        try {
